(function(){
     ...
     * @api public
     */
    function BallCollision(game, entity){
        window.game.class.PongCollision.apply(this, arguments);
    }
    BallCollision.prototype = Object.create(window.game.class.PongCollision.prototype);
    BallCollision.prototype.constructor = BallCollision;
     ...
     * @api public
     */
    BallCollision.prototype.check = function(nextPoint, moveDist, movDir){
    ...
    window.game.class.BallCollision = BallCollision;
})();